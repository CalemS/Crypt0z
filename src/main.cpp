...
//    nSubsidy >>= (nHeight / 840000); // Crypt0z: 840k blocks in ~4 years
//
//    return nSubsidy + nFees;
//}
//
static const int64 nTargetTimespan = 0.08 * 24 * 60 * 60; // Crypt0z: 2 hours / 60 Blocks
...
unsigned char pchMessageStart[4] = { 0xfc, 0xc1, 0xb5, 0xda }; // Crypt0z Peer Magic
